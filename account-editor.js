...
const PERMISSION_GROUPS = [
  ...
  ['Training & HR', [
    ...
    ['reviews.submit', 'Submit legacy performance reviews'],
    ['reviews.approve', 'Approve legacy performance reviews'],
    ['reviews.manage', 'Manage legacy review templates'],
  ...
  ['Performance Center', [
    ...
    ['performance.review.self_complete', 'Complete assigned self-evaluations'],
    ['performance.review.evaluate', 'Complete reviewer evaluation stages'],
    ['performance.review.approve', 'Approve completed evaluations'],
    ['performance.review.finalize', 'Finalize performance review records'],
    ['performance.review.reopen', 'Reopen completed performance reviews'],
    ['performance.review.delete', 'Delete performance review records'],
    ['performance.review.view_assigned', 'View assigned performance reviews'],
    ['performance.review.view_all', 'View all performance reviews'],
    ['performance.review.manage_templates', 'Create and manage review templates'],
    ['performance.review.manage_workflows', 'Create and manage approval workflows'],
    ['performance.review.manage', 'Fully administer the Performance Center'],
    ['performance.notes.private', 'View and create private performance notes'],
